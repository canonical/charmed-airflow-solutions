...
Alternatively, to report a security issue via email, please email [security@ubuntu.com](security@ubuntu.com) with a description of the issue, the steps you took to create the issue, affected versions, and, if known, mitigations for the issue.
